...
// Flechas para ver el historial mes a mes.
//
// Son LINKS, no estado de cliente: el mes viaja en la URL igual que los demás
// filtros de esta pantalla, así que la página sigue siendo un Server Component,
// el historial se filtra en la base y no en el navegador, y volver atrás en el
// navegador vuelve al mes anterior como uno espera.
//
