...
const e = StyleSheet.create({
  ...
  saludo: { fontSize: 22, fontFamily: fuente.textoSemi, color: color.tinta },
  ...
  cardEtiqueta: { fontSize: 12, fontFamily: fuente.textoMedio, color: color.tintaSecundaria },
  filaDato: {
    flexDirection: "row",
    alignItems: "baseline",
    justifyContent: "space-between",
  ...
  datoCifra: { fontSize: 17, fontFamily: fuente.monoSemi, fontVariant: ["tabular-nums"], color: color.tinta },
  filaPie: { marginTop: 8, flexDirection: "row", justifyContent: "space-between" },
  pieTexto: { fontSize: 10.5, color: color.tintaSecundaria },
  vacio: { textAlign: "center", fontSize: 13.5, fontFamily: fuente.textoMedio, color: color.verde },
  ...
  avisoTitulo: { fontSize: 13.5, fontFamily: fuente.textoMedio, color: color.tinta },
  ...
  avisoAccion: { fontSize: 12.5, fontFamily: fuente.textoMedio, color: color.verde },
